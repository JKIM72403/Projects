...
#1: Has 5 new input variables (user_verification, drink, room_temperature, room_light, want_to_change). Has 5 main if-else(elif) statements. Has 2 lists (known_users, available_caffeine_levels). Has 1 Dictionary of similar objects (current_settings). Has 2 For Loops.
...
#3: Has 1 new input variable (shared_settings). Has 1 main if-else statement. Has 1 For Loop. Has 1 Nested Dictionary.
...
#1f: Putting 1b, d, e inside of a dictionary of similar objects.
current_settings = {
...
#2e: Putting 2b, c, d input variables into a dictionary of one object
toilet_settings = {
...
#3a: Creating a nested dictionary of 'Jonathan's' user settings and the user's user settings
...
print(available_caffeine_level, current_settings, toilet_settings)