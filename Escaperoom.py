...
#Start of the Game
Username = input("Greetings. I am The Guide. I am talking to you through the walkie talkie in your hand. I will be assisting you in and narrating your escape from this tomb. How should I refer to you by?: ").lower()
