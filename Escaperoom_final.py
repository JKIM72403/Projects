...
movement_d1 = ["A. Walk around the Sarcophagus", "B. Kick the Sarcophagus a little", "C. Insert Password into Sarcophagus", "D. Leave to investigate other parts of the room"]
movement_d3 = ["A. Stare at the Sarcophagus", "B. Touch the details of the Sarcophagus", "C. Leave to investigate other parts of the room"]
...
while start:
    ...
    #Movement BACKWARD to the Sarcophagus/coffin
        ...
        while not_have_coffin_instructions:
            ...
            for option8 in movement_d3:
                print(f"{option8}")
            coffin_choice = input("What would you like to do? ").lower()
            if coffin_choice == "a":
                print("\nYou stare at the closed Sarcophagus. You notice how there is jeweled letters spelling out 'Tut'. You notice a lock system with a password. Maybe theres something in the room that contains the unknown password.")
                ...
                print("\nYou have entered an answer that I do not understand. ")
        while activate_password:
            print("\nYou are at the Sarcophagus behind your original position. Your options are to:")
            for option5 in movement_d1:
                print(f"{option5}")
            coffin_choice = input("What would you like to do? ").lower()
            if coffin_choice == "a":
                print("\nYou circle the coffin trying to notice anything about it. You notice a lock system with a password. Maybe theres something in the room that contains the unknown password.")
            elif coffin_choice == "b":
                print("\nYou give a small kick to the coffin. It doesn't budge. You wonder whats inside of the massive coffin?")
            elif coffin_choice == "c":
                password = input("\nPassword: ")
